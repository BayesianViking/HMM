...
import dataloader_top500_sequences_D1 as dataloader_top500
...
def data_dictionary():
    ...
    test_seq_AA = AA_pad[0:20]
    test_seq_DSSP = DSSP_pad[0:20]
    test_seq_Dihedral = angles_pad[0:20]
    test_lengths = mask[0:20]
    
    valid_seq_AA = AA_pad[20:30]
    valid_seq_DSSP = DSSP_pad[20:30]
    valid_seq_Dihedral = angles_pad[20:30]
    valid_lengths = mask[20:30]
